...
const products = [
  { title: "Pipe", icon: Pipe, link: "/Products/pipe/" },
  { title: "Valve", icon: Valve, link: "/Products/valve" },
  { title: "Gasket & Flange", icon: Gasket, link: "/Products/gasket-flange" },
  { title: "Fitting", icon: Fitting, link: "/Products/fitting" },
]
