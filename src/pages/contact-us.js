...
const ContactUsPage = () => (
  <div className={classNames("container py-5", styles.pageWrapper)}>
    <h1 className="general-sections-title mb-5">Contact Us</h1>
      ...
      <div className="col-12 col-lg-6 d-flex flex-column justify-content-center">
        <div className={styles.contactInfo}>
          ...
          <div className="mt-4">
            ...
            >
              <Phone size={20} className={classNames("me-2", styles.icon)} />
              <strong>Phone:</strong>
            </div>
          ...
          <div className="mt-4">
            ...
            <p className="ms-4">
              <a href="mailto:sales@energypsp.com" className={styles.emailLink}>
                sales@energypsp.com
              </a>
            </p>
          </div>
